...
namespace BloomTocTests
{
    ...
    public class TestToc
    {
	    ...
	    private static void CheckManyTocPageResults(HtmlDom dom)
	    {
		    ...
		    assertThatResult.HasSpecifiedNumberOfMatchesForXpath("//div[@class='bloom-toc']/div[@class='bloom-toc-row']/div[@class='tocItem' and @lang='en' and @data-book='toc5' and text() = 'fifth heading']", 1);
		    assertThatResult.HasSpecifiedNumberOfMatchesForXpath("//div[@class='bloom-toc']/div[@class='bloom-toc-row']/div[@class='tocItem' and @lang='en' and @data-book='toc7' and text() = 'seventh heading']", 1);
		    assertThatResult.HasSpecifiedNumberOfMatchesForXpath(
