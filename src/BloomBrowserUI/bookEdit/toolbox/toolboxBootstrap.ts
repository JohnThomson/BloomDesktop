...
import CartoonBubblesToolboxPanel from './cartoonBubbles/cartoonBubblesToolboxPanel';
...
export { CartoonBubblesToolboxPanel }; // just to make sure it gets included in the bundle (and adds an instance of itself to the collection in toolbox.ts)
