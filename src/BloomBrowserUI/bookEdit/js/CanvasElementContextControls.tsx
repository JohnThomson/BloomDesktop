...
function makeLanguageMenuItem(
    ...
    const updateTg = (
        ...
        if (editableInLang) {
            // remove editableInLand from the array editables
            ...
            // Remove classes generated by TranslationGroupManager that are specific to the original language.
            editableInLang.classList.forEach((c) => {
