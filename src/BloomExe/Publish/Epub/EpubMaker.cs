    ...
    public class EpubMaker : IDisposable
    {
        ...
        )
        {
            ...
            if (Unpaginated)
            {
                ...
                pageDom.EnsureStylesheetLinks("baseEPUB.css", "branding.css");
            }
            else
            {
                ...
                pageDom.EnsureStylesheetLinks("previewMode.css", "origami.css");
            }
            ...
            pageDom.EnsureStylesheetLinks(kCssFolder + "/" + "fonts.css"); // enhance: could omit if we don't embed any
