    ...
    public class StyleSheetLinkSorter : IComparer<XmlElement>
    {
        ...
        private static void Init()
        {
            if (_values == null)
            {
                ...
                // Don't merge into 5.7. It already has a new sorting approach.
                // 5.6 books should normally not have appearance.css, this is a temporary patch for forward compatibility.
                _values.Add("appearance.css", 70);
        ...
        private int GetValue(string s)
        {
            ...
            {
                if (
                    s.ToLowerInvariant() == pair.Key //no path in there
