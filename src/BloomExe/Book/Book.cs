...
namespace Bloom.Book
{
	public class Book
	{
		public delegate Book Factory(BookInfo info, IBookStorage storage, ISaveContext context);//autofac uses this
		...
		public Book()
		{
			...
			_saveContext = AlwaysEditSaveContext.TheOneInstance;
		}
			...
			this()
		{
			...
			_saveContext = context ?? AlwaysEditSaveContext.TheOneInstance;
		}
...
//                BookStorage.HideAllTextAreasThatShouldNotShow(dom, iso639CodeToLeaveVisible, Page.GetPageSelectorXPath(dom));
		...
		/// </summary>
		public bool IsSaveable => IsEditable && _saveContext.CanSaveChanges(BookInfo);
